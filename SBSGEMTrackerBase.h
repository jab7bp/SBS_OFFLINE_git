...
protected:
  ...
  // int fXtalk_ADCcut_val;
  // int fXtalk_runnum;
  // std::vector<std::vector<double> > fXtalk_ratios_U;
  // std::vector<std::vector<double> > fXtalk_ratios_V;
  ...
  void LoadCrosstalkRatios(const char *fname);
  ...
  std::string fXtalkfilename;
  
  TH1D *h_xtalk_layer_Nstrips_U;
  TH1D *h_xtalk_layer_Nstrips_V;
  TH1D *h_temp_U;
  TH1D *h_temp_V;

  TH1D *h_xtalk_cnt;
  TH1D *h_xtalk_removal_cnt;
  TH1D *h_xtalk_strip_cnt;
  TH1D *h_xtalk_ADCcut;
  TH1D *h_xtalk_corrected_adc_cnt;
  TH1D *h_xtalk_zero_set_cnt;

  TH1D *h_xtalk_ADCsum_nonzero_cnt;
  TH1D *h_xtalk_ADCsum_nonzero_cnt_after;
  TH1D *h_xtalk_ADCsum_nonzero_cnt_ALL;

  TH1D *h_xtalk_ADCsum_nonzero_ZS_cnt;
  TH1D *h_xtalk_ADCsum_nonzero_ZS_cnt_after;
  TH1D *h_xtalk_ADCsum_nonzero_ZS_cnt_ALL;

  TH1D *h_xtalk_hardcutoff;

  TH1D *h_xtalk_nstripsfired;
  TH1D *h_xtalk_ntracks_found;
  TH1D *h_xtalk_nstrips_keep;
  TH1D *h_xtalk_nstrips_ontrack;

  TH1D *h_xtalk_total_stripcounter;
  TH1D *h_xtalk_XtalkADCsumNonzeroLoopCnt;

  TFile *xtalk_outfile;

  int fXtalkFinalCnt;
  Long64_t fXtalkNtracks_found;
