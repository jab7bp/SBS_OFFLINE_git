...
ULong64_t xtalk_total_stripcounter = 0;
...
Int_t SBSGEMSpectrometerTracker::ReadDatabase( const TDatime& date ){
  ...
  DBRequest request[] = {
    ...
    { "xtalkfile", &fXtalkfilename, kString, 0, 1 },
  ...
  std::cout << "Crosstalk file name: " << fXtalkfilename.c_str() << std::endl;

  std::cout << "JB Modules initialized = " << fModulesInitialized << ", number of modules = " << fModules.size() << std::endl;
...
Int_t SBSGEMSpectrometerTracker::Decode(const THaEvData& evdata ){
  ...
  for( auto& module: fModules ) {
    ...
    xtalk_total_stripcounter += module->fNstrips_hit;
    //std::cout << "done..." << std::endl;
  }
...
Int_t SBSGEMSpectrometerTracker::End( THaRunBase* run ){
  ...
  int last_mod_num = fModules.size() - 1;

  if( fCrosstalk ){

    // std::cout << "#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#" << std::endl;
    // std::cout << "Should be grabbing values from crosstalk module in sbsgemspectrac" << std::endl;
    // std::cout << "#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#" << std::endl;

    // std::cout << "fmodules.size: " << fModules.size() << std::endl;

    // std::cout << "Xtalk cnt: " << fModules[last_mod_num]->fXtalkCnt << std::endl;
    h_xtalk_cnt->SetBinContent(1, fModules[last_mod_num]->fXtalkCnt);

    h_xtalk_ADCcut->SetBinContent(1, fModules[last_mod_num]->fXtalk_ADCcut_val);

    h_xtalk_removal_cnt->SetBinContent(1, fModules[last_mod_num]->fXtalkRemovalCnt);
    h_xtalk_strip_cnt->SetBinContent(1, fModules[last_mod_num]->fXtalkStripCnt);
    h_xtalk_corrected_adc_cnt->SetBinContent(1, fModules[last_mod_num]->fXtalkCorrectedADCcnt);
    h_xtalk_zero_set_cnt->SetBinContent(1, fModules[last_mod_num]->fXtalkZeroSetCnt);

    h_xtalk_ADCsum_nonzero_cnt_ALL->SetBinContent(0, fModules[last_mod_num]->fXtalkADCsumNonzeroCnt);
    h_xtalk_ADCsum_nonzero_cnt_ALL->SetBinContent(1, fModules[last_mod_num]->fXtalkADCsumNonzeroCntAfter);

    h_xtalk_XtalkADCsumNonzeroLoopCnt->SetBinContent(1, fModules[last_mod_num]->fXtalkADCsumNonzeroLoopCnt);
    h_xtalk_XtalkADCsumNonzeroLoopCnt->Write();

    h_xtalk_ADCsum_nonzero_cnt_ALL->Write();

    h_xtalk_hardcutoff->SetBinContent(1, fModules[last_mod_num]->fXtalkHardCutoff);
    
    h_xtalk_cnt->Write();
    h_xtalk_ADCcut->Write();

    h_xtalk_removal_cnt->Write();
    h_xtalk_strip_cnt->Write();
    h_xtalk_corrected_adc_cnt->Write();
    h_xtalk_zero_set_cnt->Write();
    h_xtalk_hardcutoff->Write();

  }

  h_xtalk_total_stripcounter->SetBinContent(1, xtalk_total_stripcounter);
  h_xtalk_total_stripcounter->Write();

  h_xtalk_ADCsum_nonzero_cnt->SetBinContent(1, fModules[last_mod_num]->fXtalkADCsumNonzeroCnt);
  h_xtalk_ADCsum_nonzero_cnt_after->SetBinContent(1, fModules[last_mod_num]->fXtalkADCsumNonzeroCntAfter);  
  h_xtalk_ADCsum_nonzero_cnt->Write();
  h_xtalk_ADCsum_nonzero_cnt_after->Write();  

  h_xtalk_ADCsum_nonzero_ZS_cnt->SetBinContent(1, fModules[last_mod_num]->fXtalkADCsumNonzeroZSCnt);
  h_xtalk_ADCsum_nonzero_ZS_cnt->Write();
  h_xtalk_ADCsum_nonzero_ZS_cnt_after->SetBinContent(1, fModules[last_mod_num]->fXtalkADCsumNonzeroZSCntAfter);
  h_xtalk_ADCsum_nonzero_ZS_cnt_after->Write();

  h_xtalk_ADCsum_nonzero_ZS_cnt_ALL->SetBinContent(0, fModules[last_mod_num]->fXtalkADCsumNonzeroZSCnt);
  h_xtalk_ADCsum_nonzero_ZS_cnt_ALL->SetBinContent(1, fModules[last_mod_num]->fXtalkADCsumNonzeroZSCntAfter);
  h_xtalk_ADCsum_nonzero_ZS_cnt_ALL->Write();

  h_xtalk_nstripsfired->SetBinContent(1, fModules[last_mod_num]->fXtalk_Nstrips_hit_pos);
  h_xtalk_ntracks_found->SetBinContent(1, fXtalkNtracks_found);
  h_xtalk_nstrips_keep->SetBinContent(1, fModules[last_mod_num]->fXtalk_Nstrips_keep);
  h_xtalk_nstrips_ontrack->SetBinContent(1, fModules[last_mod_num]->fXtalk_Nstrips_ontrack);


  h_xtalk_nstripsfired->Write();
  h_xtalk_ntracks_found->Write();
  h_xtalk_nstrips_keep->Write();
  h_xtalk_nstrips_ontrack->Write();
  ...
  if( fMakeEfficiencyPlots ){
    ...
    // h_xtalk_layer_Nstrips_U->Write(0, kOverwrite);
    // h_xtalk_layer_Nstrips_V->Write(0, kOverwrite);
  }
...
Int_t SBSGEMSpectrometerTracker::DefineVariables( EMode mode ){
  ...
  RVarDef vars[] = {
    ...
    { "xtalk_Ntracks_found", "total number of tracks found", "fXtalkNtracks_found"},
